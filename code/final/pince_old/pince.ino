...
//REGLAGES
#define vitesseMinA 140 //à tester, a augmenter 1 par 1 si le moteur tourne pas a la même vitesse que l'autre quand ca doit aller droit (diff physique)
...
#define pinceFerme 0 //à tester, a augmenter 1 par 1 si la pince ferme pas totalement (diff physique)
#define pinceOuverte 140 //normalement est calibré au montage (diff physique)
